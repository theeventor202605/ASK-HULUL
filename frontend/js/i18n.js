...
window.HULUL_I18N = {
  en: {
    ...
    choose_event_option: '— Choose {{term}} —', none_option: '— None —', field_meeting_type: 'Meeting type',
  ...
  ar: {
    ...
    choose_event_option: '— اختر {{term}} —', none_option: '— بدون —', field_meeting_type: 'نوع الاجتماع',
