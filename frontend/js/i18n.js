...
window.HULUL_I18N = {
  en: {
    ...
    events_title: 'Events', new_event: 'New Event', tab_overview: 'Overview', tab_chat: 'Event Chat', tab_venue: 'Venue & Zones',
    ...
    tab_escalations: 'Escalations', tab_participants: 'Participants', tab_reports: 'Reports', tab_event_log: 'Event Log',
  ...
  ar: {
    ...
    events_title: 'الفعاليات', new_event: 'فعالية جديدة', tab_overview: 'نظرة عامة', tab_chat: 'محادثة الفعالية', tab_venue: 'الموقع والمناطق',
    ...
    tab_escalations: 'التصعيد', tab_participants: 'المشاركون', tab_reports: 'التقارير', tab_event_log: 'سجل الفعالية',
